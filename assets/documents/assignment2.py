...
def main():
    ...
    The code fairy has already written the code for calculating the monthly fee for your. Don't change it.
    ...
    1. Using the input() function, ask the user the following two questions.      
        ...
        (Note: yes, it is possible to buy both memberships at once; it is also possible to buy none.)
